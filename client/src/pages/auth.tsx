      ...
      <div className="flex-1 relative overflow-hidden" role="region" aria-label="Product information">
        ...
        <div className="relative z-10 h-full flex flex-col justify-center p-12 text-white">
          <div className="max-w-lg">
            <h1 className="text-4xl font-bold mb-6" id="hero-title">
              Streamline Your Path to Better Processes
            </h1>
            <p className="text-xl mb-8 opacity-90" aria-describedby="hero-title">
            ...
            <div className="space-y-4" role="list" aria-label="Key features">
              <div className="flex items-center space-x-3" role="listitem">
                <div className="w-2 h-2 bg-[#F4A261] rounded-full" aria-hidden="true" />
