...
export const TOOL_DEFINITIONS: ToolDefinition[] = [
  ...
  },
  {
    ...
    route: '/sixsigma?tool=pareto-analysis',
    requiredTier: 'free',
  ...
  },
  {
    ...
    route: '/sixsigma?tool=value-stream',
    requiredTier: 'professional',
  ...
  },
  {
    ...
    description: 'Automated control charts with statistical process monitoring',
    category: 'Control Charts',
    route: '/sixsigma?tool=stability-tracker',
  ...
  },
  {
    ...
    route: '/sixsigma?tool=advanced-analytics',
    requiredTier: 'enterprise',
